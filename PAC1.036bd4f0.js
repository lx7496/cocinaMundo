...
})({"3c0YU":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1d9d5860036bd4f0";
"use strict";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (changeThemeButton) changeThemeButton.addEventListener("click", ()=>{
        document.body.classList.toggle("dark-theme");
    });
    const changeLanguageButton = document.getElementById("changeLanguage");
    if (changeLanguageButton) changeLanguageButton.addEventListener("click", ()=>{
    ...
    if (reservationForm) reservationForm.addEventListener("submit", (event)=>{
        ...
        alert("Reserva realizada con \xe9xito");
    });
});
